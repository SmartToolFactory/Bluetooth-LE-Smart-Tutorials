...
public class PeripheralActivityBackup extends AppCompatActivity {

    private static final String TAG = PeripheralActivityBackup.class.getName();
            ...
            public void onClick(View v) {
                ...
                if (mConnected) {
                    ...
                    if (mRegisteredDevices == null) {
                        Toast.makeText(PeripheralActivityBackup.this, "Device is NULL", Toast.LENGTH_SHORT).show();
                    }
...
//                    }
                    ...
                    Toast.makeText(PeripheralActivityBackup.this, "BLE Connection is NOT Available", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        Toast.makeText(this, "startAdvertising()", Toast.LENGTH_SHORT).show();
    ...
    private void startServer() {
        ...
        try {
            ...
            Toast.makeText(this, "Adding Card Service Failed", Toast.LENGTH_SHORT).show();
        }
    ...
    public static BluetoothGattService createTimeService() {
        ...
        // TODO Default Time Service Configs
...
//                BluetoothGattDescriptor.PERMISSION_READ | BluetoothGattDescriptor.PERMISSION_WRITE);
    ...
    private class GattServerCallback extends BluetoothGattServerCallback {
        ...
        public void onConnectionStateChange(BluetoothDevice device, int status, int newState) {
            ...
            logStatus("onConnectionStateChange() newState: " + stateString + ", device count: " + mRegisteredDevices.size());
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device, int requestId, BluetoothGattCharacteristic characteristic, boolean preparedWrite, boolean responseNeeded, int offset, byte[] value) {
            ...
            showToast("onCharacteristicWriteRequest() device: " + device.getName()
                    + ", value: " + received + ", responseNeeded: " + responseNeeded);
    ...
    private AdvertiseCallback mAdvertiseCallback = new AdvertiseCallback() {
        ...
        public void onStartSuccess(AdvertiseSettings settingsInEffect) {
            ...
            mAdvertising = true;
            invalidateOptionsMenu();
            Toast.makeText(PeripheralActivityBackup.this, "AdvertiseCallback onStartSuccess() " + settingsInEffect, Toast.LENGTH_SHORT).show();
        }
        ...
        public void onStartFailure(int errorCode) {
            ...
            mAdvertising = false;
            invalidateOptionsMenu();
            Toast.makeText(PeripheralActivityBackup.this, "AdvertiseCallback onStartFailure() " + errorCode, Toast.LENGTH_SHORT).show();
        }
