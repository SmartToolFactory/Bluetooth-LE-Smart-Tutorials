package com.bignerdranch.android.bluetoothtestbed2.server;
...
import com.bignerdranch.android.bluetoothtestbed2.R;
import com.bignerdranch.android.bluetoothtestbed2.databinding.ActivityServerBinding;
import com.bignerdranch.android.bluetoothtestbed2.util.BluetoothUtils;
import com.bignerdranch.android.bluetoothtestbed2.util.ByteUtils;
import com.bignerdranch.android.bluetoothtestbed2.util.StringUtils;

import java.util.ArrayList;
import java.util.List;
import java.util.UUID;

import static com.bignerdranch.android.bluetoothtestbed2.Constants.CHARACTERISTIC_ECHO_UUID;
import static com.bignerdranch.android.bluetoothtestbed2.Constants.SERVICE_UUID;
...
//                        | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
    ...
    private void notifyCharacteristic(byte[] value, UUID uuid) {
        mHandler.post(() -> {
            ...
            // TODO Notifies Clients that value has changed
    ...
    public void sendResponse(BluetoothDevice device, int requestId, int status, int offset, byte[] value) {
        showToast("Server sendResponse()");
        mHandler.post(() -> mGattServer.sendResponse(device, requestId, status, 0, value));
    }
    ...
    private class GattServerCallback extends BluetoothGattServerCallback {
        ...
        public void onCharacteristicReadRequest(BluetoothDevice device,
            ...
            showToast("onCharacteristicReadRequest() device: " + device.getName() + ", requestId: " + requestId);
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device,
            ...
            showToast("onCharacteristicWriteRequest() device: " + device.getName() + ", preparedWrite: " + preparedWrite
        ...
        public void onNotificationSent(BluetoothDevice device, int status) {
            ...
            showToast("onNotificationSent() device: " + device.getName() + ", status: " + status);
        }
    }
